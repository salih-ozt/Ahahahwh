...
async function compressImage(inputPath, outputPath, options = {}) {
    ...
    try {
        ...
        const { 
            ...
            limitInputPixels = 268402689 * 4  // ✅ FIX: 4x limit - makul büyük resim desteği
        } = options;
...
const upload = multer({
    storage,
    limits: {
        fileSize: 500 * 1024 * 1024, // ✅ 500MB limit - büyük dosya desteği
        files: 20,                    // ✅ 20 dosya
        fieldSize: 100 * 1024 * 1024, // ✅ 100MB field size
        fields: 100                   // ✅ Maksimum field sayısı
    },
    fileFilter
});
